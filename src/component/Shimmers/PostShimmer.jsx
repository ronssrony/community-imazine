    ...
    <div className="flex flex-col items-center justify-center "  >
        <div className="img flex items-center gap-5 w-80">
           ...
           <div  className=" text-lg w-24 h-5 rounded text-wrap bg-slate-300 animate-pulse "></div >
            ...
            <button  className="min-w-fit ml-5 justify-self-end bg-slate-300 animate-pulse text-white px-2 h-5 w-20 rounded "></button>

        </div>
        <div className='h-auto mb-10 flex-col items-center  '>
         <div className="productimg mt-2 h-96 relative">
            <img className='h-full min-w-80  object-cover bg-slate-300 animate-pulse'  alt="" />
